 ...
 * @arg void (*print_pair)(void* key, void* value) - pointer to the function, which prints elements of the pair. if NULL, default function will be assumed, interpretating key and value as int*
...
/**
 * @brief default function to free memory, pointed by key pointer. ib fact, treats key as the variable of int* or similar, e.g. not freing any memory
 * 
 * @arg void* key - pointer to the key variable
 * 
 * @return none
 */
...
/**
 * @brief default function to free memory, pointed by value pointer. ib fact, treats value as the variable of int* or similar, e.g. not freing any memory
 * 
 * @arg void* value - pointer to the key variable
 * 
 * @return none
 */
